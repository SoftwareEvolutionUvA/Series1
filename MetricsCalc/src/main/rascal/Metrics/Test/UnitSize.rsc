...
test bool testcalculateLOCofMethods() {
    loc locationTestCode = |project://Series1/test/TestCode|;
    return calculateLOCofMethods(locationTestCode) == [0, 0, 28, 14];
}

test bool testRelativeRisks() {
    loc locationTestCode = |project://Series1/test/TestCode|;
    list[int] locsRisksAbs = calculateLOCofMethods(locationTestCode);
